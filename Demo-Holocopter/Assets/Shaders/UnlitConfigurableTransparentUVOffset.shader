...
Shader "Holocopter/Unlit Configurable Transparent UV Offset"
{
    Properties
    {
        [Header(Main Color)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature DISCARD_TRANSPARENT
            #pragma shader_feature _USECOLOR_ON
            #pragma shader_feature _USEMAINTEX_ON
            #pragma shader_feature _NEAR_PLANE_FADE_ON

            #include "../HoloToolkit/Utilities/Shaders/HoloToolkitCommon.cginc"
            #include "UnlitConfigurableUVOffset.cginc"
